...
class AlertPage3OneScreen extends StatelessWidget {
  ...
  final List<Recording> recordings = [
    Recording(
      ...
      date: 'Feb 19',
      audioUrl:
          'https://solchallbucket.s3.ap-southeast-2.amazonaws.com/example2.wav',
    ),
    Recording(
      title: 'Voice 002',
      duration: '00:02:40',
      date: 'Feb 14',
      audioUrl:
          'https://solchallbucket.s3.ap-southeast-2.amazonaws.com/example1.wav',
    ),
    Recording(
      title: 'Voice 001',
      duration: '00:03:53',
      date: 'Feb 10',
      audioUrl:
          'https://solchallbucket.s3.ap-southeast-2.amazonaws.com/example3.wav',
    ),
  ];
  ...
  Future<void> _onRecordTap(BuildContext context, Recording recording) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final analysis =
            jsonDecode(response.body)['analysis'] as Map<String, dynamic>;
        int totalDetected = 0;
          ...
          itemBuilder: (context, index) {
            ...
            return Container(
              ...
              child: ListTile(
                ...
                subtitle:
                    Text(recording.duration, style: TextStyle(fontSize: 16)),
